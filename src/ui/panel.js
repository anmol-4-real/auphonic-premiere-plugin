...
const secureStorage = require("../lib/secureStorage.js");
const auphonicClient = require("../core/auphonicClient.js");
const selection = require("../core/selection.js");
const costEstimate = require("../core/costEstimate.js");
const exportModule = require("../core/export.js");
const insertion = require("../core/insertion.js");
const jobModel = require("../core/jobModel.js");
const cache = require("../core/cache.js");
const paths = require("../lib/paths.js");
const { CATEGORY, AuphonicPluginError } = require("../core/errors.js");
...
async function checkSelection() {
  ...
  try {
    ...
    if (result.diagnostics && result.diagnostics.length > 0) {
      console.log("Auphonic eligibility diagnostics (checks this build couldn't run):", result.diagnostics);
    }
